...
constinit uint8_t mod7_p[4] = {0x09, 0x70, 0xA8, 0x52};
...
constinit uint8_t mod17[8] = {0x08, 0x00, 0x90, 0x52, 0x68, 0x97, 0xA8, 0x72};
							 					 
//48 60 A8 52 [movz w8, #0x4302, lsl #16]
constinit uint8_t mod17_p[8] = {0x48, 0x60, 0xA8, 0x52};
...
constinit uint8_t mod20[8] = {0xC7, 0xFF, 0xFF, 0x17, 0x28, 0x7C, 0xA8, 0x52};
...
constinit uint8_t mod21[8] = {0xC7, 0xFF, 0xFF, 0x17, 0x28, 0x7C, 0xA8, 0x52};
